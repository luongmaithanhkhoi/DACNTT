...
//   const [loading, setLoading] = useState(true); // Loading khi check
//   const [bookmarkLoading, setBookmarkLoading] = useState(false);

//   // KIỂM TRA TRẠNG THÁI BOOKMARK KHI VÀO TRANG
//   useEffect(() => {
...
//           // Nếu API trả success = true hoặc message "already" → đã lưu
//           setIsBookmarked(result.success === true || result.message?.includes('already'));
//         }
//       } catch (err) {
...
//       if (res.ok || result.message?.includes('already')) {
...
//   if (loading) {
//     return <button className="btn btn-outline-secondary px-5 py-2 fs-5" disabled>
//       Đang tải...
//     </button>;
//   }
...
//     >
//       {bookmarkLoading ? 'Đang xử lý...' : isBookmarked ? '✅ Đã lưu' : '❤️ Lưu tin'}
//     </button>
//   );
// }
