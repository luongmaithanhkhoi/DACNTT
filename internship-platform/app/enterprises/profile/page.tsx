            ...
            <div className="bg-white rounded shadow p-5">
              ...
              <div className="row g-4 text-center">
                <div className="col-md-4">
                  <Link href="/enterprise/jobs" className="btn btn-outline-primary w-100 py-4 fs-4">
                    <i className="fa fa-briefcase fa-2x mb-3 d-block" />
                    Quản lý tin tuyển dụng
                  </Link>
                </div>
                <div className="col-md-4">
                  <Link href="/enterprise/applications" className="btn btn-outline-success w-100 py-4 fs-4">
                    <i className="fa fa-users fa-2x mb-3 d-block" />
                    Xem hồ sơ ứng tuyển
                  </Link>
                </div>
                <div className="col-md-4">
                  <Link href="/enterprise/post-job" className="btn btn-danger w-100 py-4 fs-4">
