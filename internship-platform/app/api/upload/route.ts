...
//     const fileType = formData.get('type') as string; // 'avatar' | 'cv'
...
//     const bucket = fileType === 'avatar' ? 'avatars' : 'cvs';
...
//     console.log('File uploaded successfully:', { userId: appUser.id, url: publicUrl });
...
// ✅ Helper: Get enterprise_id for ENTERPRISE role
