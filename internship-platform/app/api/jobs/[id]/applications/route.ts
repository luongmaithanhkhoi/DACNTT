...
// // Helper: Lấy jobId từ params hoặc pathname
// function extractJobId(req: Request, params?: { jobId?: string }): string | null {
//   let id = params?.jobId;
//   if (!id) {
//     const pathname = new URL(req.url).pathname;
//     const segments = pathname.split('/').filter(Boolean);
//     id = segments.at(-2); // /api/jobs/[jobId]/application → jobId ở -2
//   }
//   if (!id || id.trim() === '' || id === 'undefined' || id === 'null') return null;
//   return id.trim();
// }

// // Helper: Lấy student_id từ token
...
//   if (dbError || !appUser) {
//     console.error("User not found or not student:", dbError?.message);
//     return null;
//   }
...
// // Helper: Kiểm tra job có tồn tại và đang mở
...
// // DELETE: Rút hồ sơ (withdraw application)
